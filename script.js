...
const WOLF_IDS = ["werewolf","alpha_wolf","wolf_cub","cursed_wolf_father","dream_wolf","moon_wolf","human_werewolf"];
const NIGHT_ORDER = ["mason","cupid","doppelganger","seer","oracle","aura_seer","pi","apprentice_seer","bodyguard","doctor","witch","little_girl","troublemaker","medium","priest","arsonist","serial_killer","vampire","plague_bearer","moon_wolf","alpha_wolf","dream_wolf","cursed_wolf_father","wolf_cub","werewolf"];
